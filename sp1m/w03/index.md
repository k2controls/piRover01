...
- Build updates and scrum videos from last week
  - issues or blockers
  - lessons learned?
  - if you did not submit work then say on Zoom at the end of class. We'll make a plan to resolve.
...
- [Connecting Remotely](../../lessons/11/CreatingARemoteConnection.pdf){:target="_blank"}
  - This was previewed last week.
  - I'll repeat next session but the goal for the week is to have everyone connected with new passwords and Wi-Fi enabled.
